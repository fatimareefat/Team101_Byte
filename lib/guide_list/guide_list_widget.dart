...
import 'guide_list_model.dart';
export 'guide_list_model.dart';

class GuideListWidget extends StatefulWidget {
  const GuideListWidget({Key? key}) : super(key: key);

  @override
  _GuideListWidgetState createState() => _GuideListWidgetState();
}

class _GuideListWidgetState extends State<GuideListWidget> {
  late GuideListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuideListModel());
  }
